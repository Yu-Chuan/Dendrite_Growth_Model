...
def movingMeanParam(probability, neuronType, labname, neuronName, dendrite):
    ...
    dataPath = ['D:/Yu-Chuan/MATLAB/' + workingFolder+ '/figure/NewKbAndKt/matrixOutput/' + \
                str(labname)]
    neuronPath = []    
...
#            if n!=0:
        ...
        return 
class Neuron_two_Tm2_movemean(Neuron_two_Tm1_movmean):
    type='two-stage growing neoron'
    def nrtraj(self):
        super(Neuron_two_Tm2_movmean, self).nrtraj()
        self.neuronName = 'Tm2'

class Neuron_two_Tm9_movemean(Neuron_two_Tm1_movmean):
    type='two-stage growing neoron'
    def nrtraj(self):
        super(Neuron_two_Tm9_movmean, self).nrtraj()
        self.neuronName = 'Tm9'

class Neuron_two_Tm20_movemean(Neuron_two_Tm1_movmean):
    type='two-stage growing neoron'
    def nrtraj(self):
        super(Neuron_two_Tm20_movmean, self).nrtraj()
